...
import DancingRoach from '@/components/ui/DancingRoach'
import DancingCat from '@/components/ui/DancingCat'

interface NeofetchOutputProps {
    info: UserInfo
    artType?: 'cat' | 'roach' | 'donut'
}

export function NeofetchOutput({ info, artType = 'donut' }: NeofetchOutputProps) {
